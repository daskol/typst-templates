...
#table(
  ...
  $display((partial y) / (partial x))$, [Partial derivative of $y$ with respect to $x$],
  ...
  $display((partial f) / (partial bold(x)))$, [Jacobian matrix $bold(J) in RR^(m times n)$ of $f: RR^n arrow.r RR^m$],
